...
def categorize(name, typ, audience, country, notes, edu):
    ...
    elif typ in ("base_city", "organic") or "destination" in blob: cat = "organic"
...
# ---- 1b. inbox-approved candidates (Stage-2 discovery → user-approved; beats web candidates, loses to curated PDF) ----
